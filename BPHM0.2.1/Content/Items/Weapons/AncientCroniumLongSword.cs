...
{
    internal class AncientCroniumLongSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<InactiveEmeraldProjectile>();
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<AncientCroniumBar>(), 18)
